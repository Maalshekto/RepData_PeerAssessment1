...
```{r hist_total_number_steps, echo=TRUE, warning=FALSE, message=FALSE, fig.align='center'}
...
```{r plot_average_daily_activity, echo=TRUE, warning=FALSE, message=FALSE, fig.align='center'}
...
```{r NA_replace, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r complete_hist_total_number_steps, echo=TRUE, warning=FALSE, message=FALSE, fig.align='center'}
...
```{r weekend_weekday, echo=TRUE, warning=FALSE, message=FALSE}
